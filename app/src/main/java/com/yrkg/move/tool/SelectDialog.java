...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mContext.getResources().getColor(R.color.blue);
                mOtherItemColor = mContext.getResources().getColor(R.color.blue);
            }
            if (1 == mStrings.size()) {
